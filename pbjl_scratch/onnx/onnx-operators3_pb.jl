# Autogenerated using ProtoBuf.jl v1.0.14 on 2023-10-06T23:54:27.328
# original file: /home/ablambe/toolpath/ONNXNaiveNASflux.jl/pb_scratch/onnx-operators.proto3 (proto3 syntax)
...
OperatorProto(;op_type = "", since_version = zero(Int64), status = OperatorStatus.EXPERIMENTAL, doc_string = "") = OperatorProto(op_type, since_version, status, doc_string)
...
OperatorSetProto(;magic = "", ir_version = zero(Int64), ir_version_prerelease = "", ir_build_metadata = "", domain = "", opset_version = zero(Int64), doc_string = "", operator = Vector{OperatorProto}(), functions = Vector{FunctionProto}()) = OperatorSetProto(magic, ir_version, ir_version_prerelease, ir_build_metadata, domain, opset_version, doc_string, operator, functions)
