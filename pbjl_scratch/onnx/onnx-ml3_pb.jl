# Autogenerated using ProtoBuf.jl v1.0.14 on 2023-10-06T23:54:27.322
# original file: /home/ablambe/toolpath/ONNXNaiveNASflux.jl/pb_scratch/onnx-ml.proto3 (proto3 syntax)

import ProtoBuf as PB
using ProtoBuf: OneOf
using ProtoBuf.EnumX: @enumx

export var"TypeProto.Opaque", Version, var"TensorProto.Segment"
export var"TensorShapeProto.Dimension", StringStringEntryProto, OperatorStatus
export OperatorSetIdProto, var"TensorProto.DataLocation", var"AttributeProto.AttributeType"
...
struct var"TypeProto.Opaque"
    domain::String
    name::String
end
var"TypeProto.Opaque"(;domain = "", name = "") = var"TypeProto.Opaque"(domain, name)
PB.default_values(::Type{var"TypeProto.Opaque"}) = (;domain = "", name = "")
PB.field_numbers(::Type{var"TypeProto.Opaque"}) = (;domain = 1, name = 2)

function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:var"TypeProto.Opaque"})
    domain = ""
    name = ""
    ...
    return var"TypeProto.Opaque"(domain, name)
end

function PB.encode(e::PB.AbstractProtoEncoder, x::var"TypeProto.Opaque")
    initpos = position(e.io)
    !isempty(x.domain) && PB.encode(e, 1, x.domain)
    !isempty(x.name) && PB.encode(e, 2, x.name)
    return position(e.io) - initpos
end
function PB._encoded_size(x::var"TypeProto.Opaque")
    encoded_size = 0
...
@enumx Version _START_VERSION=0 IR_VERSION_2017_10_10=1 IR_VERSION_2017_10_30=2 IR_VERSION_2017_11_3=3 IR_VERSION_2019_1_22=4 IR_VERSION_2019_3_18=5 IR_VERSION_2019_9_19=6 IR_VERSION_2020_5_8=7 IR_VERSION_2021_7_30=8 IR_VERSION=9
...
@enumx var"TensorProto.DataType" UNDEFINED=0 FLOAT=1 UINT8=2 INT8=3 UINT16=4 INT16=5 INT32=6 INT64=7 STRING=8 BOOL=9 FLOAT16=10 DOUBLE=11 UINT32=12 UINT64=13 COMPLEX64=14 COMPLEX128=15 BFLOAT16=16 FLOAT8E4M3FN=17 FLOAT8E4M3FNUZ=18 FLOAT8E5M2=19 FLOAT8E5M2FNUZ=20
...
struct TypeProto <: var"##AbstractTypeProto"
    value::Union{Nothing,OneOf{<:Union{var"TypeProto.Tensor",var"##AbstractTypeProto.Sequence",var"##AbstractTypeProto.Map",var"##AbstractTypeProto.Optional",var"TypeProto.SparseTensor",var"TypeProto.Opaque"}}}
    denotation::String
end
TypeProto(;value = nothing, denotation = "") = TypeProto(value, denotation)
PB.oneof_field_types(::Type{TypeProto}) = (;
    value = (;tensor_type=var"TypeProto.Tensor", sequence_type=var"TypeProto.Sequence", map_type=var"TypeProto.Map", optional_type=var"TypeProto.Optional", sparse_tensor_type=var"TypeProto.SparseTensor", opaque_type=var"TypeProto.Opaque"),
)
PB.default_values(::Type{TypeProto}) = (;tensor_type = nothing, sequence_type = nothing, map_type = nothing, optional_type = nothing, sparse_tensor_type = nothing, opaque_type = nothing, denotation = "")
PB.field_numbers(::Type{TypeProto}) = (;tensor_type = 1, sequence_type = 4, map_type = 5, optional_type = 9, sparse_tensor_type = 8, opaque_type = 7, denotation = 6)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:TypeProto})
    ...
    while !PB.message_done(d)
        ...
        elseif field_number == 7
            value = OneOf(:opaque_type, PB.decode(d, Ref{var"TypeProto.Opaque"}))
        elseif field_number == 6
            denotation = PB.decode(d, String)
        else
            PB.skip(d, wire_type)
...
function PB.encode(e::PB.AbstractProtoEncoder, x::TypeProto)
    ...
    elseif x.value.name === :opaque_type
        PB.encode(e, 7, x.value[]::var"TypeProto.Opaque")
    end
...
function PB._encoded_size(x::TypeProto)
    ...
    elseif x.value.name === :opaque_type
        encoded_size += PB._encoded_size(x.value[]::var"TypeProto.Opaque", 7)
    end
...
FunctionProto(;name = "", input = Vector{String}(), output = Vector{String}(), attribute = Vector{String}(), attribute_proto = Vector{AttributeProto}(), node = Vector{NodeProto}(), doc_string = "", opset_import = Vector{OperatorSetIdProto}(), domain = "") = FunctionProto(name, input, output, attribute, attribute_proto, node, doc_string, opset_import, domain)
PB.reserved_fields(::Type{FunctionProto}) = (names = ["since_version", "status"], numbers = Union{Int,UnitRange{Int}}[2, 3])
PB.default_values(::Type{FunctionProto}) = (;name = "", input = Vector{String}(), output = Vector{String}(), attribute = Vector{String}(), attribute_proto = Vector{AttributeProto}(), node = Vector{NodeProto}(), doc_string = "", opset_import = Vector{OperatorSetIdProto}(), domain = "")
PB.field_numbers(::Type{FunctionProto}) = (;name = 1, input = 4, output = 5, attribute = 6, attribute_proto = 11, node = 7, doc_string = 8, opset_import = 9, domain = 10)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:FunctionProto})
    ...
    return FunctionProto(name, input[], output[], attribute[], attribute_proto[], node[], doc_string, opset_import[], domain)
end
